...
device coverage. Missing stripes are supported only for RAID1 with a surviving
copy; other chunk profiles require all stripe devices. Unused missing devices
